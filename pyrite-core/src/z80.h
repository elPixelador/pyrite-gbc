...
public:
	...
	CPU()
	{
		// We initialize the registers to their states immediately after bootrom has loaded.
		// As per: https://robertheaton.com/gameboy-doctor/
		this->registers.af = 0x01B0; // A = 0x01, F = 0xB0
		this->registers.bc = 0x0013; // B = 0x00, C = 0x13
		this->registers.de = 0x00D8; // D = 0x00, E = 0xD8
		this->registers.hl = 0x014D; // H = 0x01, L = 0x4D
		this->registers.sp = 0xFFFE; // SP = 0xFFFE
		this->registers.pc = 0x0100; // PC = 0x0100
	}
